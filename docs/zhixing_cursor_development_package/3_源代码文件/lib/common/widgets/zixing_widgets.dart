...
// 带图标的卡片
class ZhiXingIconCard extends StatelessWidget {
  final String title;
...
// 统计卡片
class ZhiXingStatCard extends StatelessWidget {
  final String title;
  final String value;
  final String? subtitle;
  final IconData? icon;
...
// 任务卡片
class ZhiXingTaskCard extends StatelessWidget {
  final String title;
  ...
  Color _getPriorityColor(String? priority, ThemeData theme) {
    switch (priority?.toLowerCase()) {
      case 'high':
      case 'urgent':
        return ZhiXingTheme.errorColor;
      case 'medium':
        return ZhiXingTheme.warningColor;
      case 'low':
        return ZhiXingTheme.successColor;
      default:
